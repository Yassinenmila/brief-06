<?php require_once __DIR__."/../process/home.php"?>
<section class="container mx-auto py-20 text-center">
    ...
    <a href="services.php" class="px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700">Voir nos services</a>
</section>
